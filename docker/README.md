...
through Chromium's loopback CDP endpoint (`127.0.0.1:19222`).
...
available at `http://localhost:60000`.

Port 19222 is not exposed; CDP is loopback-only. The noVNC and VNC ports are
